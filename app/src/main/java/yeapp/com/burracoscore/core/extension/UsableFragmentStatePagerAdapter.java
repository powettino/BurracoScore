...
package yeapp.com.burracoscore.core.extension;
...
public abstract class UsableFragmentStatePagerAdapter extends PagerAdapter {
    ...
    public UsableFragmentStatePagerAdapter(FragmentManager fm) {
        mFragmentManager = fm;
    }
